...
const defaultConfig = Buffer.from(fs.readFileSync("./test/configs/zappr.empty.yml", "utf8")).toString('base64');
const overrideConfig = Buffer.from(fs.readFileSync("./test/configs/zappr.approvals.yml", "utf8")).toString('base64');
