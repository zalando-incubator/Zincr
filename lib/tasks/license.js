...
var LicenseTask = /** @class */ (function (_super) {
    ...
    function LicenseTask() {
        ...
        _this.description = "New dependencies have been detected, please review them and their license before merging this pull request.";
        _this.resolution = "";
        return _this;
    }
    ...
    LicenseTask.prototype._licenseBanned = function (license, config) {
        if (!license) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        if (this.result.find(function (x) { return x.result === "failure" /* Failure */; })) {
