...
var LargeCommits = /** @class */ (function (_super) {
    ...
    function LargeCommits(appconfig, config, repo, organization) {
        ...
        _this.description = "Checks all commits for large additions to a single file. Large commits should be reviewed more carefully for potential copyright and licensing issues";
        _this.resolution = "This file contains a substantial change, please review to determine if the change comes from an external source and if there are any copyright or licensing issues to be aware of";
        _this.postAsComment = true;
        return _this;
    }
    LargeCommits.prototype.run = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var files, allFiles, _i, allFiles_1, file;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFiles(context)];
                    case 1:
                        files = _a.sent();
                        allFiles = files.filter(function (x) { return x.additions > _this.config.maxLines || x.changes > _this.config.maxLines; });
    ...
    LargeCommits.prototype.getFiles = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, context.github.pullRequests.listFiles({
