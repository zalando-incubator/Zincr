...
var FourEyePrincipleTask = /** @class */ (function (_super) {
    ...
    FourEyePrincipleTask.prototype.run = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var repo, author, isOrgMember, approvals, desc, coAuthors, coauthors_withreview, reviewers;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        coAuthors = _a.sent();
                        return [4 /*yield*/, this.dismissContributingReviewers(context, coAuthors)];
                    case 3:
                        coauthors_withreview = _a.sent();
                        return [4 /*yield*/, this.getReviewers(context, "approved")];
                    case 4:
                        reviewers = _a.sent();
                        ...
                        if (coauthors_withreview.length > 0) {
                            desc = "The reviews from " + coauthors_withreview.map(function (x) { return "@" + x; }).join(", ") + " are exclude as the pull request contains changes from those users";
                        }
                        this.result.push({
    ...
    FourEyePrincipleTask.prototype.dismissContributingReviewers = function (context, coauthors) {
        return __awaiter(this, void 0, void 0, function () {
            var response, result, contributingReviews, _i, contributingReviews_1, review;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        result = [];
                        contributingReviews = response.data.filter(function (review) { return review.state === "APPROVED" && coauthors.indexOf(review.user.login) >= 0; });
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, result.filter(this.unique)];
                }
            });
        });
    };
    FourEyePrincipleTask.prototype.getReviewers = function (context, state) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
