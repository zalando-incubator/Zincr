...
var FourEyePrincipleTask = /** @class */ (function (_super) {
    ...
    function FourEyePrincipleTask() {
        ...
        _this.description = "Pull request must be reviewed";
        _this.resolution = "Please ensure that XXX have reviewed this pull request and approve of the change";
        return _this;
    }
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.result.push({
                            ...
                            result: (approvals >= config.minimum) ? "success" /* Success */ : "failure" /* Failure */
                        });
