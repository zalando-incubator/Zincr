...
var FourEyePrincipleTask = /** @class */ (function (_super) {
    ...
    FourEyePrincipleTask.prototype.run = function (context, config) {
        return __awaiter(this, void 0, void 0, function () {
            var repo, author, isOrgMember, approvals, requiredApprovals, requiredInternal, requiredExternal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        approvals = _a.sent();
                        requiredApprovals = Math.max(config.internal, config.external, config.minimum);
                        if (approvals >= requiredApprovals) {
                            return [2 /*return*/, true];
                        }
                        if (isOrgMember) {
                            requiredInternal = config.minimum == null ? config.internal : config.minimum - 1;
                            this.result.push({
                            ...
                            requiredExternal = Math.max(config.minimum, config.external);
                            this.result.push({
