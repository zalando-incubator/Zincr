...
var FourEyePrincipleTask = /** @class */ (function (_super) {
    ...
    function FourEyePrincipleTask(appconfig, config, repo, organization) {
    ...
    FourEyePrincipleTask.prototype.run = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var author, directCollaborator, approvals, desc, coAuthors, reviews;
