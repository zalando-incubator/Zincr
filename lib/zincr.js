...
var Zincr = /** @class */ (function () {
    function Zincr(params) {
        this.appconfig = params.appconfig;
        this.taskconfig = params.taskconfig;
        this.repo = params.repo;
        this.organization = params.organization;
        this.runner = new task_runner_1.TaskRunner(params);
    }
    Zincr.prototype.onChange = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var CHECKNAME, pullRequest, event, issue, sha, valid_pr_actions, checkInfo, result, checkResult, summary, _i, _a, r, _b, _c, r, _d, _e, r, resolutions, comments, _f, _g, r, _h, _j, r, _k, _l, r, issue_comments, comment, body;
            var _this = this;
            return __generator(this, function (_m) {
                switch (_m.label) {
                    case 0:
                        ...
                        valid_pr_actions = ["opened", "edited", "reopened", "synchronize"];
                        ...
                        return [4 /*yield*/, context.github.checks.create(__assign({}, checkInfo, { status: "in_progress", output: {
                                    title: "Processing " + this.runner.tasks.length + " " + plural_1.plural("checks", "check", this.runner.tasks.length),
                                    summary: ""
                                } }))];
                    case 1:
                        // In progress feedback
                    ...
                    case 2:
                        ...
                        checkResult = __assign({}, checkInfo, { status: "completed", conclusion: result.Failure.length == 0 ? "success" : "action_required", completed_at: new Date().toISOString(), output: {
                                title: "Found " + result.Failure.length + " " + plural_1.plural("problems", "problem", result.Failure.length) + ",  " + result.Warning.length + " " + plural_1.plural("warnings", "warning", result.Failure.length),
                                summary: "",
                                text: ""
                            } });
                        summary = [];
                        ...
                        for (_b = 0, _c = result.Warning; _b < _c.length; _b++) {
                            r = _c[_b];
                            summary.push("    " + "\u2139\uFE0F" /* Warning */ + " " + r.name);
                        }
                        ...
                        resolutions = [];
                        comments = [];
                        comments.push("## \uD83E\uDD16 " + this.appconfig.appname + " found " + result.Failure.length + " " + plural_1.plural("problems", "problem", result.Failure.length) + " ,  " + result.Warning.length + " " + plural_1.plural("warnings", "warning", result.Warning.length));
                        ...
                        if (!this.taskconfig.comment) return [3 /*break*/, 7];
