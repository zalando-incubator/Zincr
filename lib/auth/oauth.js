...
function oauth(router) {
    var _this = this;
    var gh_host = process.env.GHE_HOST || "github.com";
    router.get('/github/login', function (req, res) {
        ...
        var url = "https://" + gh_host + "/login/oauth/authorize?" + params;
        //req.log({url}, 'Redirecting to OAuth')
        res.redirect(url);
    });
    router.get('/github/callback', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var tokenRes;
