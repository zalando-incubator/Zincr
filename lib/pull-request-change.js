...
function handlePullRequestChange(context) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, CHECKNAME, pullRequest, event, issue, repo, sha, runner, checkInfo, result, checkResult, summary, _i, _a, r, _b, _c, r, _d, _e, r, resolutions, comments, _f, _g, r, _h, _j, r, _k, _l, r, issue_comments, comment, body;
        return __generator(this, function (_m) {
            switch (_m.label) {
                ...
                case 3:
                    ...
                    resolutions = [];
                    comments = [];
                    comments.push("### \uD83E\uDD16 " + app_1.AppConfig.appname + " found " + result.Failure.length + " problems,  " + result.Warning.length + " warnings");
