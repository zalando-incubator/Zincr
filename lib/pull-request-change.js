...
function handlePullRequestChange(context) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, CHECKNAME, tasksToRun, pullRequest, repo, sha, checkInfo, results, _i, tasksToRun_1, task, t, ex_1, failedTasks, checkResult, summary, _a, results_1, result, resolutions, _b, failedTasks_1, result, _c, _d, subResult;
            ...
            switch (_e.label) {
                ...
                case 10:
                    ...
                    if (failedTasks.length > 0) {
                        ...
                        resolutions = [];
                        for (_b = 0, failedTasks_1 = failedTasks; _b < failedTasks_1.length; _b++) {
                            result = failedTasks_1[_b];
                            ...
                            if (result.result) {
                                ...
                                for (_c = 0, _d = result.result; _c < _d.length; _c++) {
                                    subResult = _d[_c];
