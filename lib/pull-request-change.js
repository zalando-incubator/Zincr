...
function handlePullRequestChange(context) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, CHECKNAME, pullRequest, event, issue, _plural, repo, sha, runner, checkInfo, result, checkResult, summary, _i, _a, r, _b, _c, r, _d, _e, r, resolutions, comments, _f, _g, r, _h, _j, r, _k, _l, r, issue_comments, comment, body;
        return __generator(this, function (_m) {
            switch (_m.label) {
                case 0: return [4 /*yield*/, app_1.getTasksConfig(context)];
                case 1:
                    cfg = _m.sent();
                    ...
                    if (event == "pull_request" && context.payload.action === 'review_requested')
                        return [2 /*return*/];
                    // if this a dimissal of a review, we already handling this elsewhere.
                    if (event === "pull_request_review" && context.payload.action === "dismissed")
                        return [2 /*return*/];
                    repo = context.repo();
                    sha = context.payload.pull_request.head.sha;
                    runner = new task_runner_1.TaskRunner(app_1.AppConfig, cfg, repo);
                    checkInfo = {
                        owner: repo.owner,
                        repo: repo.repo,
                        name: CHECKNAME,
                ...
                case 3:
                    ...
                    resolutions = [];
                    comments = [];
                    comments.push("## \uD83E\uDD16 " + app_1.AppConfig.appname + " found " + result.Failure.length + " " + _plural("problems", "problem", result.Failure.length) + " ,  " + result.Warning.length + " " + _plural("warnings", "warning", result.Warning.length));
