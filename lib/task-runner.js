...
var TaskRunner = /** @class */ (function() {
  function TaskRunner(params) {
    ...
    this.tasks = Object.entries(this.taskconfig).filter(function(x) {
      return x[1].enabled;
    });
          ...
          case 2:
            ...
            return [
              ...
              Promise.resolve().then(function() {
                return __importStar(
                  require(_this.appconfig.tasksdirectory + taskname)
                );
              })
            ];
          case 3:
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 7:
            result = {
              Failure: results.filter(function(x) {
                return x.summary().Failure.length > 0;
              }),
              Warning: results.filter(function(x) {
                return (
                  x.summary().Warning.length > 0 &&
                  x.summary().Failure.length == 0
                );
              }),
