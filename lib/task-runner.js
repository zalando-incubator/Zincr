...
var TaskRunner = /** @class */ (function () {
    function TaskRunner(appconfig, taskconfig, repo, organization) {
    ...
    TaskRunner.prototype.loadRunners = function () {
        return __awaiter(this, void 0, void 0, function () {
            var runners, _i, _a, task, taskname, tConfig, t, ex_1;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require(_this.appconfig.tasksdirectory + taskname)); })];
                    case 3:
                        t = new ((_b.sent()).default)(this.appconfig, tConfig, this.repo, this.organization);
                        if (t !== null) {
                            runners.push(t);
                        }
                        return [3 /*break*/, 5];
